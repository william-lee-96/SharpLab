...
mkdir REGENIE_step1_EHv5_out
mkdir REGENIE_step1_EHv5_log
...
do
	...
	mkdir REGENIE_step1_EHv5_out/$threshold
	mkdir REGENIE_step1_EHv5_log/$threshold

	for dir in AFR AMR EUR
	do

		mkdir REGENIE_step1_EHv5_out/$threshold/$dir
		mkdir REGENIE_step1_EHv5_log/$threshold/$dir

		for cohort in ARIC BioMe.Baylor BioMe.MGI CHS COPD.Broad COPD.UW FHS HyperGen JHS MESA MGH VTE VUAF WHI
		do

			mkdir REGENIE_step1_EHv5_out/$threshold/$dir/$cohort
			mkdir REGENIE_step1_EHv5_log/$threshold/$dir/$cohort
			...
			do
				...
				bsub -P acc_sharpa01a -q premium -n 48 -R span[hosts=1] -W 24:00 -o REGENIE_step1_EHv5_log/$threshold/$dir/$cohort/"$file_bn.log" \
				regenie     \
				    --step 1 \
				    ...
				    --force-step1 \
				    --out REGENIE_step1_EHv5_out/$threshold/$dir/$cohort/$file_bn
